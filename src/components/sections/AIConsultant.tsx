...
import { Sparkles, Loader2, Cpu, Check, ArrowRight, User, Rocket, ShieldCheck, Zap, BrainCircuit } from 'lucide-react';
  ...
  const handleConsult = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Your custom digital roadmap is ready.",
      });
    } catch (error) {
      toast({
        variant: "destructive",
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-24 items-start">
          ...
          <div className="hidden md:flex col-span-5 flex-col gap-6 sticky top-32">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="apple-glass p-6 rounded-[2rem] flex flex-col gap-3">
                ...
                <p className="text-xs font-medium text-foreground/80">Enterprise Grade</p>
              </div>
              <div className="apple-glass p-6 rounded-[2rem] flex flex-col gap-3">
                <Rocket className="w-8 h-8 text-accent" />
                <p className="text-[10px] font-bold uppercase tracking-widest text-foreground/40">Scale</p>
                <p className="text-xs font-medium text-foreground/80">Infinite Growth</p>
              </div>
            </div>
          </div>
          ...
          <div className="col-span-1 md:col-span-7">
            ...
            <motion.div 
              ...
              className="apple-card p-6 lg:p-12 overflow-hidden bg-card/40 border-primary/10 shadow-2xl"
            >
              ...
              <Textarea 
                placeholder="E.g., I need a high-speed e-commerce platform for a fashion brand in Uganda with mobile money integration and a robust admin dashboard..."
